...
public class Indexer {
	public static void main(String[] args) throws Exception {
		...
		String indexDir = "C:/Tika/index";
		String dataDir = "C:/Tika";
	...
	public Document getDocument(File f) throws Exception {
		...
		doc.add(new Field("content", t.parseToString(new FileInputStream(f)), Field.Store.YES,
				Field.Index.ANALYZED, Field.TermVector.WITH_POSITIONS_OFFSETS));
		doc.add(new Field("filename", f.getName(), Field.Store.YES, Field.Index.ANALYZED, Field.TermVector.WITH_POSITIONS_OFFSETS));
	...
	public void writeIndex(Document doc) throws Exception {
		writer.addDocument(doc);
	}

	public void showFile(File f) throws Exception {
