...
<%  int showingResult = (Integer)request.getAttribute("showingResult"); 
	...
	<p><a href="searchLocal.jsp">searchLocal</a>&nbsp;&nbsp;&nbsp;<a href="searchWeb.jsp">searchWeb</a>&nbsp;&nbsp;&nbsp;<a href="multiFieldSearch.jsp">多域检索</a></p>
	<form action="MultiFieldSearchServlet" method="POST">
		...
		每页显示条数:<input type="text" name="pageSize" value="<%=pageSize %>" size="1">
		检索词:<input	type="text" name="keyword" value="<%=keyword%>"><input type="submit" /> 
		<input type="reset"	/><br/>
		<br/>
		选定的检索域：<% 
					for(String f : fields) {%>
